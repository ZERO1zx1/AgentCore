...
Энэхүү баримт нь Manus-mini-skill төслд AI провайдерийн кредит/коин зарцуулалтыг хэмжих, харуулах, дохиолох, мөн automatic policy-үүдээр зарцуулалтыг хянах ерөнхий архитектур, өгөгдлийн схем, болон жишээ кодыг агуулж байна.
